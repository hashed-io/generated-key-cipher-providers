...
describe('PasswordGeneratedKeyCipher', () => {
  ...
  test('cipher/decipher', async () => {
    ...
    let fullCipheredPayload = await passwordCipher1.cipher({ payload: rawPayload })
    ...
    fullCipheredPayload = await passwordCipher1.cipher({ payload: rawPayload, type: 'json' })
    // console.log('encrypted: ', fullCipheredPayload)
    decipheredPayload = await passwordCipher1.decipher({ fullCipheredPayload })
    // console.log('decipheredPayload: ', decipheredPayload)
